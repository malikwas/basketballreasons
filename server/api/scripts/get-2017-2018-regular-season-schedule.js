...
const schedule = {};
schedule.startDate = "20161017";
schedule.endDate = "20170411";
schedule.calendar = [];
...
setTimeout(() => {
  ...
  fs.writeFile(`${__dirname}/output/2017-2018-regular-season-schedule.json`, JSON.stringify(schedule, null, 2));
}, 10000);
